var bg,sunR,sunL,s_pan,fan_anim,fan_img,display,gHouse_image
...
function load_img() {
    ...
    gHouse_image=loadImage("greenhouse.png")
}
...
function preload(){
    ...
    pan2=createSprite(80,height-50,80,80)
    pan2.addImage(s_pan)
    pan2.scale=0.75
    ...
    fan2=createSprite(280,300,20,20)
